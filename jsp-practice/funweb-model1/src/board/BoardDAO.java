...
public class BoardDAO {
	...
	public List<BoardBean> getBoardList(int startRow, int pageSize) {
		...
		return boardList;
	} // public List<BoardBean> getBoardList(int startRow, int pageSize) 종료
	...
	public List<BoardBean> getBoardList(String keyword, int startRow, int pageSize) {
		...
		return boardList;
	} // public List<BoardBean> getBoardList(String keyword, int startRow, int
		// pageSize) 종료
	...
	// 게시판 글 수정 메소드 : 자료실
		public int fUpdateBoard(BoardBean jbean) {
			int check = -1; // num 없음
			try {
				// 1,2단계 드라이버 로드/디비 연결
				con = getConnection();
