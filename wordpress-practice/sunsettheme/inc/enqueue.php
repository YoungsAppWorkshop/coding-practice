...
function sunset_load_admin_scripts( $hook ) {
  ...
  if ( $hook == 'toplevel_page_sunset_admin' ) {
  ...
  } else if ( $hook == 'sunset_page_sunset_admin_css' ) {
...
function sunset_load_scripts() {
  ...
  // Deregister pre-registered jQuery and enqueue jQuery manually for performance
