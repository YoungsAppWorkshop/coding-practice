...
function sunset_contact_add_meta_box() {
  add_meta_box('contact_email', 'User Email', 'sunset_contact_email_callback', 'sunset-contact', 'side', 'high');
}
...
function sunset_contact_email_callback($post) {
  ...
  $value = esc_attr(get_post_meta($post->ID, '_contact_email_value_key', true));
