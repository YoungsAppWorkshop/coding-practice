...
function sunset_posted_footer() {
  ...
  $output = '<div class="post-footer-container"><div class="row">';
  $output .= '<div class="col-xs-12 col-sm-6">' . get_the_tag_list('<div class="tags-list"><span class="sunset-icon sunset-tag"></span>', ' ', '</div>') . '</div>';
  $output .= '<div class="col-xs-12 col-sm-6 text-right">' . $comments . '</div>';
  $output .= '</div></div>';
  return $output;
}
