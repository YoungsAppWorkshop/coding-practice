...
<article id="post-<?php the_ID(); ?>" <?php post_class('sunset-format-gallery'); ?>>
  ...
  <header class="entry-header text-center">
      ...
      <div id="post-gallery-<?php the_ID(); ?>" class="carousel slide sunset-carousel-thumb" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          ?>
            ...
            <div class="item <?php echo $attachment['class']; ?> backgroud-image standard-featured" style="background-image: url( <?php echo $attachment['url']; ?>);">
          ...
          <div class="table">
            <div class="table-cell">
              <div class="preview-container">
                <span class="thumbnail-container backgroud-image"></span>
    ...
    <div class="entry-meta"><?php echo sunset_posted_meta(); ?></div>
  </header>
