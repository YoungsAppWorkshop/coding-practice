...
public class QuizCardPlayer {
	...
	class NextCardListener implements ActionListener {
		public void actionPerformed(ActionEvent ev) {
			// if this is a question, show the answer, otherwise show next
			// question
	...
	private void loadFile(File file) {
		...
		// called from the OpenMenuListener event handler, reads the file one
		// line at a time
		// and tells the makeCard() method to make a new card out of the line
		// (one line in the file holds both the question and answer, separated
		// by a "/")
	}
